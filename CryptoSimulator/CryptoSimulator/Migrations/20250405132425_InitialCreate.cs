    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CryptoLogs", x => x.CryptoId);
                    table.ForeignKey(
                        name: "FK_CryptoLogs_Cryptos_CryptoId",
                        column: x => x.CryptoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyCryptos", x => new { x.WalletId, x.CryptoId });
                    table.ForeignKey(
                        name: "FK_MyCryptos_Cryptos_CryptoId",
                        column: x => x.CryptoId,
                        principalTable: "Cryptos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MyCryptos_Wallets_WalletId",
                        column: x => x.WalletId,
